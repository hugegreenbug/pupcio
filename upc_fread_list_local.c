...
/*                       E-mail: yyy@gwu.edu                            */
/************************************************************************/
// upc_fread_list_local.c
#include <upc.h>
#include <stdlib.h>
#include <stdio.h>
#include "upc_io.h"

int64_t upc_all_fread_list_local( upcio_file_t *fh_shared,
				  ...
				  upc_flag_t sync_mode )
{
	...
	UPC_ADIO_ReadStrided( fd, memvec_entries, mem_ptrs, mem_lengths, filevec_entries, file_offsets, 
