...
int test_write_strided( Plfs_fd *fd )
{
    ...
    size = UPC_ADIO_WriteStrided( fd, mem_list_count, mem_ptrs, mem_lengths, file_list_count, 
			   file_offsets, file_lengths, &error_code );
    assert( error_code != -1 );
